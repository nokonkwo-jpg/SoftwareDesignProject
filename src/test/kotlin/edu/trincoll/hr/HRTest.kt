...
class HRTest {
    ...
    fun `test hiring and paying employees`() {
        ...
        val employees = listOf(salariedEmployee1, hourlyEmployee1)
        assertCloseTo(4000.0, hr.payEmployees(employees))
    }
    ...
    fun `test firing an employee`() {
        val hr = HR()
            ...
            .hire(hourlyEmployee1)
            .fire(1)
        val employees = listOf(hourlyEmployee1)
        assertCloseTo(2000.0, hr.payEmployees(employees))
    }
